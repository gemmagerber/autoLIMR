...
with Markov Chain Monte Carlo (LIM_MCMC).

autoLIMR achieves this by:
* 1. Translating network input data into files directly compatible with R packages [LIM](https://cran.r-project.org/web/packages/LIM/index.html) and
...
[limSolve](https://cran.r-project.org/web/packages/limSolve/index.html)
* 3. Evaluates if the multiple plausible networks are representitave of the
