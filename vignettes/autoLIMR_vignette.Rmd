...
## Installation
The latest version of '__autoLIMR__' can be installed from [GitHub](https://github.com/gemmagerber/autoLIMR). __autoLIMR__ dependencies are automatically installed, including cellranger (≥ 1.1.0) (Bryan, 2016), readxl (≥ 1.4.0) (Wickham and Bryan, 2022), and utils (≥ 4.2.0) (R Core Team, 2022). 
...
familiar with R. The latest version of __autoLIM-Excel__ can be download from the [autoLIM-Excel GitHub repository](https://github.com/gemmagerber/autoLIM-Excel) or downloaded to the working directory with the autoLIMR function `fetch_autoLIMExcel()` during an active R session.
