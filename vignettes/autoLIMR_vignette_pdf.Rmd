...
(ref:network-image-png) *Conceptual four-compartment network*

```{r network-image-png, eval = TRUE, echo = FALSE, out.width = "100%", fig.align = 'justified', fig.cap = '(ref:network-image-png)'}
